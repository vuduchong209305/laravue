    ...
    <div id="app">
        <div class="wrapper">
            ...
            <aside class="main-sidebar">
                ...
                <button type="submit" name="search" id="search-btn" class="btn btn-flat"><i class="fa fa-search"></i>
                    ...
                    <ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-table"></i> <span>Quản lý cửa hàng</span>
                                <span class="pull-right-container">
                                    <i class="fa fa-angle-left pull-right"></i>
                                </span>
                            </a>
                        ...
                        <li class="treeview">
                            <a href="#">
                                <i class="fa fa-share"></i> <span>Quản lý website</span>
                                <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
                            </a>
                            <ul class="treeview-menu">
                                ...
                                <li><a href="#"><i class="fa fa-circle-o"></i> Side</a></li>
                        ...
                        <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Phân quyền</span></a></li>
                    </ul>
                </section>
                <!-- /.sidebar -->
            </aside>
            ...
            <footer class="main-footer">
                ...
                <strong>Laravel + VueJS </strong> Admin Template AdminLTE.
            </footer>
